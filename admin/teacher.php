...
<div>
  <center><h2 style="font-size:2.5em; top: 50%;">Teachers</h2></center>
</div>
      ...
      <div class="form-group">
        ...
        <option value="a">Admin</option>
           ...
           <div class="form-group">
            ...
            <?php 
              require('connect.php');
              $query = $conn->prepare("SELECT * FROM `subjectinfo`");
              $query->execute();
              $r = $query->get_result();
              echo "<select class='form-control sub1' name = 'sub1' required>";
              echo "<option value='' disabled selected>Select Subject 1</option>";
           ...
           <div class="form-group">
            ...
            <?php 
              ...
              $query->execute();
              $r = $query->get_result();
              echo "<select class='form-control sub2' name = 'sub2' required>";
              echo "<option value='' disabled selected>Select Subject 2</option>";
              while (($row = $r->fetch_assoc())!=null)
                {
                  echo "<option value = '{$row['subjectid']}'";
           ...
           <div class="form-group">
            ...
            <?php 
              ...
              $query->execute();
              $r = $query->get_result();
              echo "<select class='form-control sub3' name = 'sub3' required>";
              echo "<option value='' disabled selected>Select Subject 3</option>";
              while (($row = $r->fetch_assoc())!=null)
                {
                  echo "<option value = '{$row['subjectid']}'";
           ...
           <div class="form-group">
            ...
            <?php 
              ...
              $query->execute();
              $r = $query->get_result();
              echo "<select class='form-control sub4' name = 'sub4' required>";
              echo "<option value='' disabled selected>Select Subject 4</option>";
              while (($row = $r->fetch_assoc())!=null)
                {
                  echo "<option value = '{$row['subjectid']}'";
           ...
           <div class="form-group">
            ...
            <?php 
              ...
              $query->execute();
              $r = $query->get_result();
              echo "<select class='form-control sub5' name = 'sub5' required>";
              echo "<option value='' disabled selected>Select Subject 5</option>";
              while (($row = $r->fetch_assoc())!=null)
                {
                  echo "<option value = '{$row['subjectid']}'";
