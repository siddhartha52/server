...
<div>
  <center><h2 style="font-size:2.5em; top: 50%;">Subjects</h2></center>
</div>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered">
		  <div class="modal-content">
			...
			<div class="modal-body">
			  <table class="table"><thead id="tablehead"><tr ><th></th><th>Class</th><th>Subject Name</th></tr></thead><tbody>
<tbody>
<tr>
<td>
Add:
...
<?php 
  ...
  $query->execute();
  $r = $query->get_result();
  echo "<select class='form-control' name = 'classid' required>";
...
<td>
<input name="subname" class='form-control' id="txt" type="text" required></input>
</td>
</tr>
</tbody>
</table>
